...
app.get('/backup', async function (req, res) {
  ...
  try {
    ...
    if (!foundUser) {
      ...
      return respond(res, {text: 'Already verified', text2: '<i>You are the <b>'+getNth(userIndex)+'</b> member</i><br /><br />out of '+doc.users.length+' members', color: 'orange', guild: guild})
    }
    //
    await doc.save();
    //add role
